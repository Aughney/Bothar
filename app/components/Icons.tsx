export function ConnectionIcon({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SolanaLogo({ className = "h-8 w-auto" }: { className?: string }) {
...
export function SuperteamLogo({ className = "h-8 w-auto" }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 64 64" className={className} xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <g fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M32 36c-6-6-12-6-12-12a6 6 0 1 1 12 0c0 4-2 4 0 12z" fill="currentColor" />
        <path d="M32 36c6-6 12-6 12-12a6 6 0 1 0-12 0c0 4 2 4 0 12z" fill="currentColor" />
        <path d="M32 36c-6 6-6 12-12 12a6 6 0 1 0 12 0c0-4 2-4 0-12z" fill="currentColor" />
        <path d="M32 36c6 6 6 12 12 12a6 6 0 1 1-12 0c0-4-2-4 0-12z" fill="currentColor" />
